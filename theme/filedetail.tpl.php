...
<table class="plugin" width="100%" border="0" cellspacing="0" cellpadding="2" style="padding-bottom:10px;">
    <tr>
        <td class="aligntop" style="padding:15px 10px 5px 10px;">
          ...
          <?php } else { ?>
            <div style="padding-bottom:10px;"><img src="<?php print $fileicon; ?>">&nbsp;<a href="<?php print url('filedepot_download/' . $nid . '/' . $fid, array('absolute' => true)); ?>" title="<?php print t('Direct link to file'); ?>" <?php print $disable_download ?>><strong><?php print $filetitle ?></strong></a>&nbsp;<span style="font-size:8pt;"><?php print $current_version ?></span></div>
          <?php } ?>
